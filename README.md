...
AI가 코디를 추천하는 멀티 판매자 패션 마켓플레이스 **코디랩(CodiLab)**과, 고객 문의를 자동 응대·관찰하는 **AI Ops Console**을 한 저장소에서 실행하는 포트폴리오 프로젝트입니다. 상품 탐색부터 주문 후 클레임까지의 커머스 흐름과 OpenRouter 응답, Langfuse 프롬프트·트레이스를 함께 확인할 수 있습니다.
